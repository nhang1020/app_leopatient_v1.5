...
// import 'package:app/src/controllers/notification_manager/utils.dart';
...
class NotificationHelper {
  ...
  Future<void> initNotification() async {
    ...
    AndroidInitializationSettings android =
        const AndroidInitializationSettings('@drawable/patient_logo');
  ...
  static Future _notificationDetails(
    ...
    return NotificationDetails(
      android: AndroidNotificationDetails(
        ...
        largeIcon: !showImage
            ? DrawableResourceAndroidBitmap("@drawable/patient_logo")
            : DrawableResourceAndroidBitmap("@drawable/congratulation"),
        color: myColor,
        colorized: true,
